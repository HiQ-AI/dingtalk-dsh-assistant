...
test('运行看板保留左侧菜单并替换右侧整体内容', async () => {
  ...
  assert.match(source, /padding: '0 0 11px'[\s\S]*fontSize: 13, fontWeight: 500, lineHeight: '16px'/)
  ...
  assert.match(source, /'Agent 投递'\), React\.createElement\('th',[\s\S]*'发送人 \/ 时间'\), React\.createElement\('th',[\s\S]*'消息内容'/)
  ...
  assert.match(source, /padding: activePage === 'tasks' \? '24px 24px 0' : '24px 24px 32px'/)
