...
const taskContext = z.strictObject({ kind: z.literal('task-context'), taskId: z.string().min(1), ...taskVersion, context: z.string().min(1), objective: z.string().min(1).optional(), ...runPlan, ...taskSources })
